...
public class ModificarComentario extends Fragment {
    ...
    public static ModificarComentario newInstance(String u) {
        ModificarComentario frag = new ModificarComentario();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        l = inflater.inflate(R.layout.modificarcomentario, container, false);
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Modificar Comentario");
        b1 = l.findViewById(R.id.bbuscarcoment);
        b2 = l.findViewById(R.id.bmodificarcomentario);
        b2.setEnabled(false);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!t1.getText().toString().isEmpty()) {
                    modificarComentario(contenido.getText().toString(), "http://192.168.0.13/appausamovil/modificarComentario.php");
                } else {
    ...
    private void modificarComentario(final String contenido, String url) {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                insertlog(user, "Comentario modificado Exitoso", "Se modifico el comentario con ID:" + idcom, "http://192.168.0.13:80/appausamovil/insertarlog.php");
                clear2();
                b2.setEnabled(false);
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                ;
                insertlog(user, "Comentario modificado Fallido", "Se trato de modificar un comentario con el ID:" + idcom, "http://192.168.0.13:80/appausamovil/insertarlog.php");
            }
        }) {
            @Override
    ...
    private void buscarComentario(final String idcom, String url) {
        if (!idcom.isEmpty()) {
            JsonArrayRequest js = new JsonArrayRequest(url + idcom, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            Toast.makeText(l.getContext(), "Comentario encontrado, finalizar de click en Modificar", Toast.LENGTH_LONG).show();
                            b2.setEnabled(true);
                            clear1();
                ...
                @Override
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(l.getContext(), "El ID ingresado no esta asociado a ninguna cuenta", Toast.LENGTH_LONG).show();
