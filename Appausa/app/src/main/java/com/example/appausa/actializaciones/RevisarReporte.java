...
public class RevisarReporte extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Revisar Reporte");
    ...
    private void cambiarEstadoReporte() {
        String idr = tv1.getText().toString();
        StringRequest sr = new StringRequest(Request.Method.POST, "http://192.168.0.13:80/appausamovil/actualizarReporte.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                a.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        log.insertlog(user, "Reporte modificado exitoso", "Se evaluo el reporte: " + idr, "http://192.168.0.13:80/appausamovil/insertarlog.php", l.getContext());
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(l.getContext(), "Problemas en la evaluacion del reporte"+ idr, Toast.LENGTH_LONG).show();
                log.insertlog(user, "Reporte modificado fallido", "Se trato de evaluar el reporte" + idr, "http://192.168.0.13:80/appausamovil/insertarlog.php", l.getContext());            }
        }) {
            @Override
